...
<head>
    ...
    <link href="../../../backend/assets/customCSS/style.css" type="text/css" rel="stylesheet" id="user-style-default">
...
<body>
    ...
    <main class="main" id="top">
        <div class="container-fluid bg-body-tertiary dark__bg-gray-1200">
            <div class="bg-holder bg-auth-card-overlay" style="background-image:url(../../../backend/assets/img/bg/37.png);">
            </div>
            <!--/.bg-holder-->
                        ...
                        <div class="card-body pe-md-0">
                            <div class="row align-items-center gx-0 gy-7">
                                <div class="col-auto bg-body-highlight dark__bg-gray-1100 rounded-3 position-relative overflow-hidden auth-title-box">
                                    <div class="bg-holder" style="background-image:url(../../../backend/assets/img/bg/38.png);">
                                    </div>
                                    <!--/.bg-holder-->
                                    ...
                                    <div class="position-relative z-n1 mb-6 d-none d-md-block text-center mt-md-15"><img class="auth-title-box-img d-dark-none" src="../../../backend/assets/img/spot-illustrations/auth.png" alt="" /><img class="auth-title-box-img d-light-none" src="../../../backend/assets/img/spot-illustrations/auth-dark.png" alt="" /></div>
                                </div>
